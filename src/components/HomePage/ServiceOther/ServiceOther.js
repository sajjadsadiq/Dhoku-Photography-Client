        ...
        <section className="ServiceOther" >
            <div className="container ">
                <div className="otherServiceContent">
                    <h6 className="text-danger d-flex justify-content-center mt-5">OTHER SERVICE</h6>
                    <h2  className="d-flex justify-content-center" >We also provide</h2>
                </div>

                <div className="row mt-5">
                    {
                        otherServicesData.map(otherServices => <ServiceOtherShow otherServices={otherServices}/> )
                    }
                </div>
            </div>
        </section>
